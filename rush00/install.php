<?php
	...
	$sql = "INSERT INTO products (id, title, img, intro, price, category)
			...
			(2, 'Onions', 'http://spicexpert.ru/files/Image/luk-rep.jpg', 'Onions are awful', '13', 'Greens'),
			(3, 'Deer', 'http://arvi.by/wp-content/uploads/2017/12/%D0%B31-1-300x300.jpg', 'Deers lives matter', '50', 'Meat'),
			(4, 'Carrot', 'https://freshproducegroup.us/wp-content/uploads/2018/02/CARROT-FRESH-PRODUCE-GROUP-LLC.jpg', 'Carrot is super-duper', '7', 'Greens'),
			(5, 'Chicken', 'http://cdn.shopify.com/s/files/1/1090/8304/products/whole_chicken_with_skinCompressed_grande.jpg?v=1449925650', 'Nom-nom chicken', '30', 'Meat'),
			(6, 'Grape', 'https://hmarapara.com/media/2018/03/Grape-Candy-300x300.jpg', 'Graaaaape', '20', 'Fruits'),
			(7, 'Banana', 'https://images-na.ssl-images-amazon.com/images/I/41JvAoqeMfL._SY300_QL70_.jpg', 'Bananas are whoaaa', '15', 'Fruits'),
			(8, 'Pork', 'http://renzostampa.com/sites/default/files/styles/grill_thumbnails/public/thumbnail-crudas/pork_loin_boneless3.png?itok=SzJz0tDt', 'Halal pork', '42', 'Meat'),
			(9, 'Cabbage', 'https://images-na.ssl-images-amazon.com/images/I/416Xjyn1R6L._SY300_QL70_.jpg', 'Cabbage helps with health issues', '9', 'Greens')";
	if (!mysqli_query($conn, $sql)) {
